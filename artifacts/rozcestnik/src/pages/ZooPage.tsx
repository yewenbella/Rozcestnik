...
export default function ZooPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(10,30,25,0.85) 100%)" }} />
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "20px", padding: "40px 24px" }}>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.9rem", lineHeight: 1.6, margin: 0 }}>
              {"Sekce se p\u0159ipravuje.\nBrzy zde najdete seznam ZOO v\u00a0Česk\u00e9 republice."}
            </p>
          </div>
          <div style={{
            background: "rgba(20,184,166,0.08)", border: "1px solid rgba(20,184,166,0.3)",
            borderRadius: "12px", padding: "14px 20px",
            color: "#5eead4", fontSize: "0.82rem", fontWeight: 600, textAlign: "center",
          }}>
            {"🐘 Připravujeme pro vás seznam zoologických zahrad"}
          </div>
        </div>
      </div>
    </div>
