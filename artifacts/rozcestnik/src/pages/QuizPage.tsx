...
const questions: Question[] = [
  { question: "Který hrad je nejnavštěvovanějším hradem v České republice?", options: ["Karlštejn", "Křivoklát", "Bezděz"], correct: 0, hint: "Postaven Karlem IV. roku 1348." },
  ...
  { question: "Jak se jmenují dvě věže hradu Trosky?", options: ["Čert a Káča", "Adam a Eva", "Baba a Panna"], correct: 2, hint: "Vyšší věž má 57 m, nižší 45 m." },
  { question: "Ve stylu jakého hradu byl přestavěn zámek Hluboká nad Vltavou?", options: ["Windsorského hradu", "Buckinghamského paláce", "Pařížského Louvru"], correct: 0, hint: "Přestavba proběhla v 19. století rodem Schwarzenbergů." },
  ...
  { question: "Pražský hrad je považován za:", options: ["Nejstarší hrad Evropy", "Nejlépe zachovaný gotický hrad", "Největší hradní komplex světa"], correct: 2, hint: "Do Guinessovy knihy rekordů byl zapsán díky své rozloze." },
  { question: "V jaké turistické oblasti se nachází hrad Kost?", options: ["Český ráj", "Krkonoše", "Šumava"], correct: 0, hint: "Gotický hrad z 14. století, přezdívaný nejlépe zachovaný v Čechách." },
  ...
  { question: "Oblast Lednice-Valtice je od roku 1996 zapsána na:", options: ["Červené knize ohrožených míst", "Seznamu národních přírodních rezervací", "Seznamu UNESCO světového dědictví"], correct: 2, hint: "Tzv. 'zahrada Evropy' — největší zahradní kompozice světa." },
  { question: "Hrad Frýdlant je neodmyslitelně spjat s postavou:", options: ["Albrechta z Valdštejna", "Jana Žižky", "Přemysla Otakara II."], correct: 0, hint: "Slavný generalissimus třicetileté války." },
  ...
  { question: "Hrad Loket byl ve středověku využíván jako:", options: ["Státní vězení", "Klášter", "Sídlo biskupů"], correct: 0, hint: "Byl zde uvězněn i Goethe — ne, ten ho jen navštívil!" },
  ...
  { question: "Ve kterém okrese leží zámek Hluboká nad Vltavou?", options: ["České Budějovice", "Strakonice", "Písek"], correct: 0, hint: "Jihočeský kraj, poblíž krajského města." },
  ...
  { question: "Kolik věží má hrad Trosky celkem?", options: ["Dvě", "Jednu", "Tři"], correct: 0, hint: "Baba a Panna — obě stojí na čedičovém bradlu." },
  { question: "Hrad Kost leží na potoce:", options: ["Mohelka", "Plakánek", "Klenice"], correct: 1, hint: "Romantické údolí Plakánek — malebné skalní útesy." },
